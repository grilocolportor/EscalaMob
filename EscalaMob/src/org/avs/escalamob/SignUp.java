package org.avs.escalamob;

import org.avs.interfaces.IAppManager;
import org.avs.services.IMService;
						...
						)
					{
						...
						if (passwordText.getText().toString().equals(passwordAgainText.getText().toString())){
							...
							if (usernameText.length() >= 5 && passwordText.length() >= 5) {
									...
									localstoragehandler = new LocalStorageHandler(SignUp.this);
									// Display a notification about us starting. We put an icon in the
									// status bar.
									// showNotification();
									
									localstoragehandler.insertUsuario(usernameText.getText().toString(), 
											eMailText.getText().toString(), 
											passwordAgainText.getText().toString());
